...
public class IntegrationService {
	...
	public List<Product> getProductList() { 
		...
		ResponseEntity<ProductResponseInfo> response =
		restTemplate.exchange(url,HttpMethod.GET,entity, ProductResponseInfo.class);
		...
		public Product getProductById(String id) {
			...
			ResponseEntity<ProductResponseInfo> response = restTemplate.exchange(URL + "/product/" + id, HttpMethod.GET, entity,
		...
		public String updateProduct(Product product) {
			...
			ResponseEntity<String> response = restTemplate.exchange(URL + "/product", HttpMethod.PUT, entity,
			String.class);
			HttpStatus statusCode = response.getStatusCode();
			return response.getBody();
			}
